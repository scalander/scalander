...
class MeetingTimeProposal:
    ...
    committed_attendences: List[str] # UIDs that are commited
    unavailable_attendences: List[str] # UIDs that are not commited
...
def get_proposal(id):
    ...
    return MeetingTimeProposal(proposal.meeting.id, proposal.start, proposal.end, committed_subscription_ids, unavailable_subscription_ids, proposal.optimality)
